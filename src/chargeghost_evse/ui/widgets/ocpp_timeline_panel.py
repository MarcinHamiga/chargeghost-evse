...
class OCPPTimelinePanel(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        dir_label.setObjectName("timelineFilterLabel")
        ...
        action_label.setObjectName("timelineFilterLabel")
        ...
        actions_row = QWidget()
        actions_row.setObjectName("timelineActionsRow")
